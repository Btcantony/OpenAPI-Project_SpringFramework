...
public class Api {
	...
	public List<MyBankVo> accounts() {
		...
		//3. MyBankVO(전체 계좌 조회를 위해) 
		String accessKey = "ukZlJXXRdDK3uWBknpjLQIfsbeyEQPl7iyeHBaKn";
        String secretKey = "jw0ALijK326vxRiy8xrh2o87NivQj0PE0hXm8zB6";
